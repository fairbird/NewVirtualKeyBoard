...
class NewVirtualKeyBoard(Screen, textInputSuggestions, kb_layoutComponent, KBLayoutLanguages):
    ...
    def __init__(self, session, title='', text='', maxSize=False, visible_width=False, visibleWidth=False, currPos=None, windowTitle=None, allMarked=False, type=Input.TEXT):
